...
<div class="row">
    <div class="col-4">
        <img class="col" src="../image/<?=$donnees['image']?>" alt="">
    </div>
    ...
    <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item "><a class="btn btn-secondary" href="select.php">Retour</a></li>
        <li class="list-group-item " ><a class="btn btn-success" href="reservationadmin.php?id='<?=$idp;?>''">Reserver</a></li>
        </div>
    </ul>
